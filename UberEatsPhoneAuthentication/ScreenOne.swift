...
class ScreenOne: UIView {
    ...
    public var selfTapHandler: (() -> Void)!
    public var countryFlagTapHandler: (() -> Void)!
    ...
    @objc func didTapCountryCode() {
        countryFlagTapHandler()
    }

}

extension ScreenOne: NibLoading {
    public static func instantiate() -> ScreenOne {
        guard let view = ScreenOne.fromNib(nib: Nib.screenOne) else {
